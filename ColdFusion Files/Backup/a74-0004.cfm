...
<td width="30%" rowspan="2" valign="top"><img src="#fileService.getFile(fileDir = "/keydoc/images", filename = "Trident_Prep_Lusaka.jpg", includeHTTP = "https:")#" style="height:5.5cm;"/></td>
<td width="40%" style="color:##2E3192;padding-top:1cm;">End of Term Report<br/>#year#</td>
...
<td style="color:##2E3192;padding-bottom:2cm;">#getList.FirstName[i]# #getList.LastName[i]#<br/>Year #ListGetAt(StudGrade,#ListFirst(Replace(getList.AcYear[i], "Yr", ""), "_")#)#</td>
</tr>
</table>
</td>
</tr>
...
<tr align="center" class="txtRep10Bold" style="background-color:##EBEBF9;">
...
<td>
<table cellpadding="0" cellspacing="0" width="100%" align="center">
<tr align="center" class="txtRep11Bold" style="background-color:##EBEBF9;">
...
<cfquery name="THREAD.getDet2" datasource="#ATTRIBUTES.dsn#">
    SELECT C0.Title, C0.ColHeading, ((D.Mark / C0.OutOf) * 100) AS Mark, (
    SELECT TOP 1 Grade FROM StudYearGrade G
...
<tr align="left" class="txtRep12Bold" style="background-color:##EBEBF9;">
...
<tr align="left" class="txtRep11Bold" style="color:##2E3192;">
...
<tr align="left" class="txtRep11Bold" style="background-color:##EBEBF9;">
...
<tr align="left" class="txtRep11" style="background-color:##EBEBF9;">
