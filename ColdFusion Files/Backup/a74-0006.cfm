...
<cfquery name="getList" datasource="#dsn#">
    SELECT A.StudID,
           ...
           MAX(A.MiddleName) AS MiddleName,
           MAX(A.TermYear) AS TermYear,
           MAX(A.Term) AS Term,
           MAX(A.AcYear) AS AcYear,
           MAX(A.BirthDate) AS BirthDate,
           MAX(A.Photo) AS Photo,
           MAX(A.AdmNo) AS AdmNo,
           MAX(A.Age) AS Age,
           MAX(C.Class) AS Class,
           MAX(T.FirstName) AS TFName,
           MAX(T.LastName) AS TLName,
           MAX(T.Title) AS Title,
           MAX(T.TeacherID) AS TeacherID,
           MAX(T.T1SignFile) AS T1SignFile
    FROM vARSubjAcads A
    LEFT JOIN TTClassStud C 
        ON C.TermYear = A.TermYear AND C.Term = A.Term
       AND C.AcYear = A.AcYear AND C.StudID = A.StudID
    LEFT JOIN vTTClasses T 
        ON T.Class = C.Class AND T.ClYear = C.TermYear AND T.ClTerm = C.Term
    WHERE ARSID = #ARSID#
    <cfif RecNo NEQ 0> AND A.StudID = #RecNo#</cfif>
    GROUP BY A.StudID
    ORDER BY LastName, FirstName, StudID
</cfquery>
...
<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
	...
	<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
		<tr style="vertical-align:top;">
			...
			<td align="right" style="width:45%;"><img src="#fileService.getFile(fileDir = "/keydoc/assessment", filename = "Sentinel_Kabitaka.png", includeHTTP = "https:")#" style="height:2.1cm;"></td>
		</tr>
	</table>
	</td>
	</tr>
	...
	<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
		<tr>
			...
			<td align="right" class="txtRep14">Class: <b>#Replace(getList.AcYear[i],'_KAB','')#</b></td>
		</tr>
	</table>
	</td>
	</tr>
	...
	<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
		...
		<cfloop query="getSubj">
			<tr>
				<td class="bleft btop bbottom txtRep11Bold" colspan="2" style="color:##FFFFFF;background-color:##0061b0;padding:3px 5px;">#SubjName#</td>
				<td class="btop bottom bright txtRep11Bold" style="color:##FFFFFF;background-color:##0061b0;padding:3px 5px;">#T1Title# #LEFT(T1FName, 1)# #T1LName#</td>
			</tr>
			<tr><cfloop query="getOpt"><td class="<cfif CurrentRow EQ 1>bleft</cfif> bbottom bright txtRep11" align="left" style="padding:5px 0px 5px 80px;">#OptName# <cfif OptCode EQ AssessmentGrade><img src="#fileService.getFile(fileDir = "/keydoc/assessment", filename = "tick.png", includeHTTP = "https:")#" style="height:12pt;float:right;padding-right:50px;"></cfif></td></cfloop></tr>
			<tr><td colspan="3" style="height:60px;vertical-align:top;padding:3px 5px;" class="bleft bbottom bright txtRep11">#Replace(Comment, Chr(13), "<br />", "All")# </td></tr>
			<cfif CurrentRow NEQ RecordCount><tr><td style="height:20px;"></td></tr></cfif>
		</cfloop>
	</table>
	</td>
	</tr>
...
<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
	...
	<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
		...
		<tr>
			<td class="bleft btop bbottom txtRep11Bold" colspan="2" style="color:##FFFFFF;background-color:##0061b0;padding:3px 5px;">#getComms.HeadingRep#</td>
			<td class="btop bottom bright txtRep11Bold" style="color:##FFFFFF;background-color:##0061b0;padding:3px 5px;">#getList.Title# #LEFT(getList.TFName[i], 1)# #getList.TLName[i]#</td>
		</tr>
		<tr><td colspan="3" style="height:60px;vertical-align:top;padding:3px 5px;" class="bleft bbottom bright txtRep11">#Replace(getComms.Comment, Chr(13), "<br />", "All")# </td></tr>
		<tr><td style="height:20px;"></td></tr>
	</table>
	</td>
	</tr>
	...
	<tr><td align="left" style="height:60px;"><cfif getCF.SignFile NEQ "" AND fileService.checkFileExist(fileDir  = "/keydoc/signatures/#getCF.StaffID#", filename = "#getCF.SignFile#")>
		<img src="#fileService.getFile(fileDir = "/keydoc/signatures/#getCF.StaffID#", filename = "#getCF.SignFile#", includeHTTP = "https:")#" style="position:relative;height:60px;padding-left:10px;padding-bottom:1px;" /></cfif></td></tr>
	<tr><td align="left" class="txtRep11Bold"></td></tr>
