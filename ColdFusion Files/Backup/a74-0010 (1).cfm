...
<td width="30%" rowspan="2" valign="top"><img src="#fileService.getFile(fileDir = "/keydoc/images", filename = "Trident_Prep_Solwezi.png", includeHTTP = "https:")#" style="height:5.5cm;"/></td>
<td width="40%" style="color:##9f1f63;padding-top:1cm;">End of Term Report<br/>#year#</td>
...
<td style="color:##9f1f63;padding-bottom:2cm;">#getList.FirstName[i]# #getList.LastName[i]#<br/>Year #ListGetAt(StudGrade,#ListFirst(Replace(getList.AcYear[i], "Yr", ""), "_")#)#</td>
</tr>
</table>
</td>
</tr>
...
<tr align="center" class="txtRep10Bold" style="background-color:##FDF1F7;">
...
<td>
<table cellpadding="0" cellspacing="0" width="100%" align="center">
<tr align="center" class="txtRep11Bold" style="background-color:##FDF1F7;">
...
<tr align="left" class="txtRep12Bold" style="background-color:##FDF1F7;">
...
<tr align="left" class="txtRep11Bold" style="color:##9f1f63;">
...
<tr align="left" class="txtRep11Bold" style="background-color:##FDF1F7;">
...
<tr align="left" class="txtRep11" style="background-color:##FDF1F7;">
<td style="padding:2px 5px;" class="bleft btop bbottom"><b>#getComms.HeadingRep[2]#</b></td>
<td class="btop bright bbottom" style="padding:2px 5px;" align="right"><i>
    <cfif getComms.CommPerson[2] EQ 5>#ucFirst(getManagement.PTitle, true, true)#<cfif getManagement.PTitle NEQ "">.</cfif> #LEFT(getManagement.PFName, 1)# #ucFirst(getManagement.PLName, true, true)#
    <cfelseif getComms.CommPerson[2] EQ 4>#ucFirst(getManagement.DTitle, true, true)#<cfif getManagement.DTitle NEQ "">.</cfif> #LEFT(getManagement.DFName, 1)# #ucFirst(getManagement.DLName, true, true)#
    <cfelseif getComms.CommPerson[2] EQ 1>#ucFirst(getManagement.GHTitle, true, true)#<cfif getManagement.GHTitle NEQ "">.</cfif> #LEFT(getManagement.GHFName, 1)# #ucFirst(getManagement.GHLName, true, true)#
    <cfelseif getComms.CommPerson[2] EQ 2>#ucFirst(getManagement.ASTitle, true, true)#<cfif getManagement.ASTitle NEQ "">.</cfif> #LEFT(getManagement.ASFName, 1)# #ucFirst(getManagement.ASLName, true, true)#
    <cfelseif getComms.CommPerson[2] EQ 3>#ucFirst(getManagement.PHTitle, true, true)#<cfif getManagement.PHTitle NEQ "">.</cfif> #LEFT(getManagement.PHFName, 1)# #ucFirst(getManagement.PHLName, true, true)#
    <cfelseif getComms.CommPerson[2] EQ 6>#ucFirst(getManagement.LBMTitle, true, true)#<cfif getManagement.LBMTitle NEQ "">.</cfif> #LEFT(getManagement.LBMFName, 1)# #ucFirst(getManagement.LBMLName, true, true)#
    <cfelse>#ucFirst(getList.Title[i], true, true)#<cfif getList.Title[i] NEQ "">.</cfif> #LEFT(getList.TFName[i], 1)# #ucFirst(getList.TLName[i], true, true)#
    </cfif>
</i></td>
</tr>
<tr align="left" class="txtRep11" valign="top">
...
<cfquery name="getComms1" datasource="#dsn#">
    ...
    SELECT A.Seq, A.SCode, A.SubjName, A.ARSID, SS.Comment, A.Remarks, A.T1Title,A.T1FName, A.T1LName
    FROM vARSubjAcads A
    LEFT JOIN ARCommSetup CS ON CS.TermYear = A.TermYear AND CS.Term = A.Term AND CS.StudYear = A.AcYear AND CS.Type = 2 AND CS.Reference = 'E'
    LEFT JOIN ARAcadComm SS ON SS.CommSetupID = CS.CommSetupID AND SS.AcadID = A.AcadID
    ...
    AND A.AcYear = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getList.AcYear[i]#">
    AND A.RepCard = 0 AND SS.Comment <> ''
    ORDER BY A.Seq
</cfquery>


<cfloop index = "k" from = "1" to = "#getComms1.recordCount#">
<cfif year GTE 2024 AND getComms1.Comment[k] NEQ "">
<tr>
<td>
<table cellpadding="0" cellspacing="0" width="100%" align="center" >
<tr>
...
<tr align="left" class="txtRep11" style="background-color:##FDF1F7;">
<td style="padding:2px 5px;" class="bleft btop bbottom"><b>#getComms1.SubjName[k]#</b></td>
<td class="btop bright bbottom" style="padding:2px 5px;" align="right"><i>#ucFirst(getComms1.T1Title[k], true, true)#<cfif getComms1.T1Title[k] NEQ "">.</cfif> #LEFT(getComms1.T1FName[k], 1)# #ucFirst(getComms1.T1LName[k], true, true)#</i></td>
</tr>
<tr align="left" class="txtRep10" valign="top">
<td colspan="2" class="bleft bright bbottom" style="padding:2px 5px;height:2cm;">#Replace(getComms1.Comment[k], Chr(13), "<br />", "All")#</td>
</tr>
</table>
</td>
</tr>
...
<td class="btop bright bbottom" style="padding:2px 5px;" align="right"><i>
    <cfif getComms.CommPerson[1] EQ 5>#ucFirst(getManagement.PTitle, true, true)#<cfif getManagement.PTitle NEQ "">.</cfif> #LEFT(getManagement.PFName, 1)# #ucFirst(getManagement.PLName, true, true)#
    <cfelseif getComms.CommPerson[1] EQ 4>#ucFirst(getManagement.DTitle, true, true)#<cfif getManagement.DTitle NEQ "">.</cfif> #LEFT(getManagement.DFName, 1)# #ucFirst(getManagement.DLName, true, true)#
    <cfelseif getComms.CommPerson[1] EQ 1>#ucFirst(getManagement.GHTitle, true, true)#<cfif getManagement.GHTitle NEQ "">.</cfif> #LEFT(getManagement.GHFName, 1)# #ucFirst(getManagement.GHLName, true, true)#
    <cfelseif getComms.CommPerson[1] EQ 2>#ucFirst(getManagement.ASTitle, true, true)#<cfif getManagement.ASTitle NEQ "">.</cfif> #LEFT(getManagement.ASFName, 1)# #ucFirst(getManagement.ASLName, true, true)#
    <cfelseif getComms.CommPerson[1] EQ 3>#ucFirst(getManagement.PHTitle, true, true)#<cfif getManagement.PHTitle NEQ "">.</cfif> #LEFT(getManagement.PHFName, 1)# #ucFirst(getManagement.PHLName, true, true)#
    <cfelseif getComms.CommPerson[1] EQ 6>#ucFirst(getManagement.LBMTitle, true, true)#<cfif getManagement.LBMTitle NEQ "">.</cfif> #LEFT(getManagement.LBMFName, 1)# #ucFirst(getManagement.LBMLName, true, true)#
    <cfelse>#ucFirst(getList.Title[i], true, true)#<cfif getList.Title[i] NEQ "">.</cfif> #LEFT(getList.TFName[i], 1)# #ucFirst(getList.TLName[i], true, true)#
    </cfif>
</i></td>
</tr>
...
<td class="btop bright bbottom" style="padding:2px 5px;" align="right"><i>
    <cfif getComms.CommPerson[3] EQ 5>#ucFirst(getManagement.PTitle, true, true)#<cfif getManagement.PTitle NEQ "">.</cfif> #LEFT(getManagement.PFName, 1)# #ucFirst(getManagement.PLName, true, true)#
    <cfelseif getComms.CommPerson[3] EQ 4>#ucFirst(getManagement.DTitle, true, true)#<cfif getManagement.DTitle NEQ "">.</cfif> #LEFT(getManagement.DFName, 1)# #ucFirst(getManagement.DLName, true, true)#
    <cfelseif getComms.CommPerson[3] EQ 1>#ucFirst(getManagement.GHTitle, true, true)#<cfif getManagement.GHTitle NEQ "">.</cfif> #LEFT(getManagement.GHFName, 1)# #ucFirst(getManagement.GHLName, true, true)#
    <cfelseif getComms.CommPerson[3] EQ 2>#ucFirst(getManagement.ASTitle, true, true)#<cfif getManagement.ASTitle NEQ "">.</cfif> #LEFT(getManagement.ASFName, 1)# #ucFirst(getManagement.ASLName, true, true)#
    <cfelseif getComms.CommPerson[3] EQ 3>#ucFirst(getManagement.PHTitle, true, true)#<cfif getManagement.PHTitle NEQ "">.</cfif> #LEFT(getManagement.PHFName, 1)# #ucFirst(getManagement.PHLName, true, true)#
    <cfelseif getComms.CommPerson[3] EQ 6>#ucFirst(getManagement.LBMTitle, true, true)#<cfif getManagement.LBMTitle NEQ "">.</cfif> #LEFT(getManagement.LBMFName, 1)# #ucFirst(getManagement.LBMLName, true, true)#
    <cfelse>#ucFirst(getList.Title[i], true, true)#<cfif getList.Title[i] NEQ "">.</cfif> #LEFT(getList.TFName[i], 1)# #ucFirst(getList.TLName[i], true, true)#
    </cfif>
</i></td>
</tr>
