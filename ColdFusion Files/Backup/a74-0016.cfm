...
<tr align="left" class="txtRep10" style="background-color:##C00000;color:##FFFFFF;">
...
<td>
<table cellpadding="0" cellspacing="0" width="100%" align="center">
<tr align="left" class="txtRep10" valign="bottom">
<td width="7%" style="height:60px;">Name:</td>
<td width="23%" class="bbottom"></td>
<td width="5%"></td>
<td width="7%">Sign:</td>
<td width="23%" class="bbottom"></td>
<td width="5%"></td>
...
<img src="#fileService.getFile(fileDir = "/keydoc/signatures/#getCF.StaffID#", filename = "#getCF.SignFile#", includeHTTP = "https:")#" style="position:relative;height:60px;padding-left:10px;padding-bottom:1px;"  /></cfif><br/>
#ucFirst(getCF.Title, true, true)# #ucFirst(getCF.FirstName, true, true)# #ucFirst(getCF.LastName, true, true)#</td>
</tr>
</table>
</td>
</tr>
