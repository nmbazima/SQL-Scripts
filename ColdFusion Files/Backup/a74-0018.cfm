...
<td width="50%" align="right"><img src="#fileService.getFile(fileDir = "/keydoc/images", filename = "Sentinel_Kalumbila.png", includeHTTP = "https:")#" style="height:2cm;"/></td>
</tr>
</table>
</td>
</tr>
...
<cfif #ListFirst(Replace(getList.AcYear[i], "Yr", ""), "_")# EQ 7>
<tr>
<td colspan="2">
<table cellpadding="0" cellspacing="0" width="100%" align="center">
...
<td width="17%" class="btop bright bbottom" style="background-color:##818285;color:##FFFFFF;"><b>Days Absent</b></td>
<td width="17%" class="btop bright bbottom"><cfif getStudAtt.Absent NEQ "">#NumberFormat(getStudAtt.Absent)#<cfelse>0</cfif></td>
<td width="17%" class="btop bright bbottom" style="background-color:##818285;color:##FFFFFF;"><b>Detentions</b></td>
<td width="17%" class="btop bright bbottom"><cfif getDetent.Detention NEQ "">#NumberFormat(getDetent.Detention)#<cfelse>0</cfif></td>
</tr>
</table>
</td>
</tr>
...
<table cellpadding="0" cellspacing="0" width="100%" align="center">
<tr align="center" class="txtRep9">
<td width="20%" class="ball" style="background-color:##C00000;color:##FFFFFF;"><b>Star of the Week</b></td>
...
<table cellpadding="0" cellspacing="0" width="100%" align="center">
<tr valign="top">
<td width="65%" class="ball" style="background-color:##C00000;padding:8px 5px;">
<table cellpadding="0" cellspacing="0" width="100%" align="center">
...
<table cellpadding="0" cellspacing="0" width="100%" align="center">
<cfif #ListFirst(Replace(getList.AcYear[i], "Yr", ""), "_")# EQ 7>
<tr align="center" class="txtRep10Bold" style="background-color:##C00000;color:##FFFFFF;">
<td width="26%" style="padding:2px 0px;" class="ball">Subject</td>
<td width="22%" class="btop bright bbottom">Teacher</td>
<td width="15%" class="btop bright bbottom">Achievement</td>
<td width="15%" class="btop bright bbottom">Effort</td>
<td width="22%" class="btop bright bbottom">Term Grade</td>
</tr>
<cfelse>
<tr align="center" class="txtRep10Bold" style="background-color:##C00000;color:##FFFFFF;">
<td width="25%" style="padding:2px 0px;" class="ball">Subject</td>
<td width="25%" class="btop bright bbottom">Achievement</td>
<td width="25%" class="btop bright bbottom">Effort</td>
<td width="25%" class="btop bright bbottom">Term Grade</td>
</tr>
</cfif>
...
<td class="bright bbottom">#ucFirst(threadResult.T1Title, true, true)#<cfif threadResult.T1Title NEQ "">.</cfif> #LEFT(threadResult.T1FName, 1)#. #ucFirst(threadResult.T1LName, true, true)#</td>
<td class="bright bbottom"><cfif threadResult.getDet.Mark NEQ "">#threadResult.getDet.Grade#</cfif></td>
...
<td>
<table cellpadding="0" cellspacing="0" width="100%" align="center">
<tr align="left" class="txtRep10Bold" style="background-color:##C00000;color:##FFFFFF;">
