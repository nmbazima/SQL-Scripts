...
<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
	...
	<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
		...
		<cfloop query="getSubj">
			<tr>
				<td class="bleft btop bbottom txtRep11Bold" colspan="2" style="color:##FFFFFF;background-color:##0061b0;padding:1px 5px;">#SubjName#</td>
				<td class="btop bottom bright txtRep11Bold" style="color:##FFFFFF;background-color:##0061b0;padding:1px 5px;">#T1Title# #LEFT(T1FName, 1)# #T1LName#</td>
			</tr>
	...
	<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
		...
		<tr>
			<td class="bleft btop bbottom txtRep11Bold" colspan="2" style="color:##FFFFFF;background-color:##0061b0;padding:1px 5px;">#getComms.HeadingRep#</td>
			<td class="btop bottom bright txtRep11Bold" style="color:##FFFFFF;background-color:##0061b0;padding:1px 5px;">#getList.Title# #LEFT(getList.TFName[i], 1)# #getList.TLName[i]#</td>
		</tr>
...
<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
	<tr>
		<td style="width:60%" align="right"><img src="#fileService.getFile(fileDir = "/keydoc/assessment", filename = "EducoreServices.png", includeHTTP = "https:")#" style="height:1.2cm;"></td>
