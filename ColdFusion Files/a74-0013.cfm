...
<cfquery name="getSubj" datasource="#dsn#">
    SELECT A.SCode, CASE WHEN A1.SumVal = '' THEN 0 ELSE CAST(A1.SumVal AS INTEGER) END AS Sumval
    FROM vARSubjAcads A
    ...
    WHERE A.TermYear = #year# AND A.Term = #term# AND A.StudID = #RecNo# AND A.RepCard = 0 AND A.SType <> 'R' AND A.Page <> 0 AND A1.Sumval IS NOT NULL
</cfquery>

<cfquery dbtype="query" name="getSum">
    SELECT SUM(Sumval) AS TSumval
    FROM getSubj
</cfquery>

<cfif getSubj.RecordCount GT 0>
<cfset EffortScore = #getSum.TSumval# / #getSubj.RecordCount#>
<cfelse>
<cfset EffortScore = 0>
</cfif>
...
<tr>
<td align="center" class="txtRep22Bold"><cfif #NumberFormat(EffortScore, 9.9)-0# EQ 1>Perfect Effort;<cfelseif #NumberFormat(EffortScore, 9.9)-0# GTE 1.1 AND #NumberFormat(EffortScore, 9.9)-0# LTE 1.2>Outstanding Effort;<cfelseif #NumberFormat(EffortScore, 9.9)-0# GTE 1.3 AND #NumberFormat(EffortScore, 9.9)-0# LTE 1.5>Excellent Effort;</cfif> Cycle <cfif term EQ 1>1<cfelseif term EQ 2>2<cfelseif middate GT 0>3<cfelseif term EQ 3>4</cfif>, Year #ListFirst(Replace(getList.AcYear[i], "Yr", ""), "_")#, #year#</td>
</tr>
...
<tr>
<td align="center" class="txtRep22">Effort Score #NumberFormat(EffortScore, 9.9)-0#</td>
</tr>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"8a082b4899b095f5","r":1,"version":"2024.4.1","token":"24487d2a7ed944b994f951dd5266a78e"}' crossorigin="anonymous"></script>
</body>
