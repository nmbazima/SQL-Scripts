...
<td colspan="2">Mid-Term Report: #DateFormat(Now(), "MMMM YYYY")#</td>
</tr>
...
<td width="60%" style="color:##FFFFFF;" class="btop bright bbottom">Grade Description</td>
</tr>
...
<table cellpadding="0" cellspacing="0" width="100%" align="center">
<tr align="center" class="txtRep10Bold" style="background-color:##0060af;">
<td width="33%" style="padding:2px 0px;color:##FFFFFF;" class="ball">Attainment</td>
<td width="34%" style="color:##FFFFFF;" class="btop bright bbottom">Division</td>
<td width="33%" style="color:##FFFFFF;" class="btop bright bbottom">Grade Description</td>
</tr>

<cfloop query="getGrades">
<tr align="center" class="txtRep10">
<td style="padding:2px 0px;" class="bleft bright bbottom">#NumberFormat(MinPercent)# - #NumberFormat(MaxPercent)#%</td>
<td class="bright bbottom">Division #Grade#</td>
<td class="bright bbottom">#ListFirst(GradeDet, " (")#</td>
</tr>
</cfloop>
</table>
</td>
...
<td width="14%" style="color:##FFFFFF;" class="btop bright bbottom">Assessment 1<br/>Grade</td>
<td width="14%" style="color:##FFFFFF;" class="btop bright bbottom">Assessment 1<br/>Attainment %</td>
<td width="14%" style="color:##FFFFFF;" class="btop bright bbottom">Assessment 2<br/>Grade</td>
<td width="14%" style="color:##FFFFFF;" class="btop bright bbottom">Assessment 2<br/>Attainment %</td>
...
<cfquery name="getDetA1" datasource="#dsn#">
	...
	FROM vARSubjAcads A
    LEFT JOIN ARAssCol C0 ON C0.ARSID = A.ARSID AND C0.Lvl = 0 AND C0.ColHeading = 'A1'
...
<cfquery name="getDetA2" datasource="#dsn#">
	...
	ORDER BY MinPercent DESC) AS Grade
	FROM vARSubjAcads A
    LEFT JOIN ARAssCol C0 ON C0.ARSID = A.ARSID AND C0.Lvl = 0 AND C0.ColHeading = 'A2'
    LEFT JOIN ARAssColData D ON D.ARAssColID = C0.ARAssColID AND D.AcadID = A.AcadID
	WHERE A.TermYear = #year# AND A.Term = #term# AND A.StudID = #RecNo# AND A.SCode = '#SCode#'
</cfquery>
