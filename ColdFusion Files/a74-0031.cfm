...
<table cellpadding="0" cellspacing="0" align="center" style="width:28cm;height:19cm;padding-top:20px;">
...
<table cellpadding="0" cellspacing="0" align="center" style="width:100%">
    ...
    <tr><td align="center" style="font:normal 56pt 'Edwardian Script ITC';padding-top:8.1cm;">#getList.FirstName[i]# #getList.MiddleName[i]# #getList.LastName[i]#</td></tr>
	...
	<table cellpadding="0" cellspacing="0" align="center" style="width:100%">
		<tr>
			<td align="center" style="font:normal 16pt 'Georgia';padding-top:4.3cm;width:34%;padding-bottom:0.5cm;">#DateFormat(getStudent.LeftDate,'D MMMM YYYY')#</td>
			<td align="center" style="padding-top:2.7cm;width:32%;"><cfif getCF.SignFile NEQ "" AND fileService.checkFileExist(fileDir  = "/keydoc/signatures/#getCF.StaffID#", filename = "#getCF.SignFile#")>
				<img src="#fileService.getFile(fileDir = "/keydoc/signatures/#getCF.StaffID#", filename = "#getCF.SignFile#", includeHTTP = "https:")#" style="height:90px;padding-top:0.5cm;" /></cfif></td>
