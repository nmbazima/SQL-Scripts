...
<cfquery name="getLBM" datasource="#dsn#">
	...
	WHERE D.TermYear = #year# 
	 ...
	 AND T.TypeName = 'End of Year - Certificate of Achievement (V1)'
...
<table cellpadding="0" cellspacing="0" align="center" style="width:100%">
    ...
    <tr><td align="center" style="font:normal 56pt 'Edwardian Script ITC';padding-top:7.5cm;">#getList.FirstName[i]# #getList.MiddleName[i]# #getList.LastName[i]#</td></tr>
	<tr><td align="center" style="font:normal 28pt 'Georgia';padding-top:1.7cm;">#Detail#<br />#Reason#</td></tr>
