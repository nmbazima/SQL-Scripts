...
<cfquery name="getLBM" datasource="#dsn#">
	SELECT L.Detail, L.LogDate, L.CreatedBy, T.TypeName, S.Title, S.FirstName, S.LastName, C.Category, C.CategoryType, S.SignFile, S.StaffID
	FROM BHMLogs AS L 
	...
	WHERE D.TermYear = #year# AND D.Term = #term# AND L.StudentID = #RecNo# AND C.CategoryType = 'Reward' AND T.TypeName = 'Star of the Week!' AND L.Status = 'Awarded'
	ORDER BY L.LogDate
</cfquery>
...
<table cellpadding="0" cellspacing="0" align="center" style="width:29cm;height:20cm;padding-top:20px;" class="watermark">

<tr style="vertical-align:top;">
<td>
<table cellpadding="0" cellspacing="0" align="center" style="width:100%">

	<tr><td align="center" style="font:normal 14pt 'Palantino';color:##C09100;padding-top:6.2cm;"><b><i>THIS ACKNOWLEDGES THAT</i></b></td></tr>
    <tr><td align="center" style="font:normal 30pt 'Palantino';color:##818285;padding-top:1.2cm;"><b><i>#getList.FirstName[i]# #getList.MiddleName[i]# #getList.LastName[i]#</i></b></td></tr>
	<tr><td align="center" style="font:normal 14pt 'Palantino';color:##C09100;padding-top:1cm;"><b><i>IS AWARDED THIS CERTIFICATE FOR </i></b></td></tr>
	<tr><td align="center" style="font:normal 16pt 'Palantino';color:##818285;padding-top:0.8cm;"><b><i>#Detail#</i></b></td></tr>
	...
	<table cellpadding="0" cellspacing="0" align="center" style="width:100%">
		...
		<tr>
			<td style="width:60%;color:##818285;font:normal 12pt 'Palantino';padding:92px 0px 0px 130px;" align="left"><b><i>DATE: #DateFormat(LogDate,'DD.MM.YYYY')#</i></b></td>
			<td style="width:40%;color:##C09100;font:normal 14pt 'Palantino';padding-top:20px;" align="center"><b><i>TEACHER'S NAME: #ListLast(CreatedBy,',')# #ListFirst(CreatedBy,',')#<br /><br />#getList.AcYear[i]#</i></b></td>
		</tr>
...
.watermark{
background-image: url("https://s3-eu-west-1.amazonaws.com/client-z5n97j6prh/Public%20folder/SKABP_Star_of_the_week.png");
