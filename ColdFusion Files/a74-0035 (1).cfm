...
<td colspan="2">MOCK EXAM RESULTS: OCTOBER #year#</td>
</tr>
...
<td colspan="2">Explanation of achievement grades</td>
</tr>

<tr align="left" class="txtRep10">
<td colspan="2" style="padding-left:30px;"><b>•</b>    Years 7 are following the Examinations Council of Zambia for grading work and assessments.</td>
<tr align="left" class="txtRep10">
<td colspan="2" style="padding-left:30px;"><b>•</b>    Your child has been given two grades.</td>
</tr>
</table>
</td>
</tr>
...
<table cellpadding="0" cellspacing="0" width="100%" align="center">
<tr valign="top">
<td class="ball" style="background-color:##0061b0;padding:8px 5px;">
<table cellpadding="0" cellspacing="0" width="100%" align="center">
...
<td width="34%" style="padding:2px 0px;" class="ball">Subject</td>
<td width="18%" class="btop bright bbottom">Exam Mark</td>
<td width="18%" class="btop bright bbottom">IGCSE Grade</td>
<td width="30%" class="btop bright bbottom">Teacher</td>
</tr>
...
<cfquery name="THREAD.getDet" datasource="#ATTRIBUTES.dsn#">
    ...
    LEFT JOIN ARAssCol C2 ON C2.ARSID = A.ARSID AND C2.Lvl = 1 AND C2.ColHeading = 'Assess 2'
