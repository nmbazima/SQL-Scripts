...
<td colspan="2">END OF TERM REPORT: #UCase(DateFormat(getTerm.EndDate, "MMMM YYYY"))#</td>
</tr>
...
<td colspan="3" class="bleft bright bbottom" style="padding:2px 5px;">#Replace(threadResult.getSubjCom.Comment, Chr(13), "<br />", "All")#&nbsp;</td>
</tr>
</cfif>
...
<tr align="left" class="txtRep9" valign="top">
<td colspan="2" class="bleft bright bbottom" style="padding:2px 5px;">#Replace(getComms.Comment, Chr(13), "<br />", "All")#&nbsp;</td>
</tr>
</table>
</td>
</tr>
