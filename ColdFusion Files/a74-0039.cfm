...
<td class="bright bbottom"><cfif threadResult.getDet.C1Mark[1] NEQ "">#NumberFormat(threadResult.getDet.C1Mark[1])#</cfif></td>
<td class="bright bbottom"><cfif threadResult.getDet.C2Mark[2] NEQ "">#NumberFormat(threadResult.getDet.C2Mark[2])#</cfif></td>
<td class="bright bbottom"><cfif threadResult.getDet.C3Mark[3] NEQ "">#NumberFormat(threadResult.getDet.C3Mark[3])#</cfif></td>
<td class="bright bbottom"><cfif threadResult.getDet.C4Mark[3] NEQ ""><b>#NumberFormat(threadResult.getDet.C4Mark[3])#</b></cfif></td>
<td class="bright bbottom"><cfif threadResult.getDet.C4Mark[3] NEQ "">#threadResult.getDet.C4Grade[3]#</cfif></td>
<td class="bright bbottom"><cfif threadResult.getSubjSum.Sumval NEQ "">#threadResult.getSubjSum.Sumval#</cfif></td>
<td class="bright bbottom"><cfif threadResult.getDet.AvgMark[3] NEQ ""><b>#NumberFormat(threadResult.getDet.AvgMark[3])#</b></cfif></td>
