...
<cfquery name="getLBM" datasource="#dsn#">
	...
	WHERE D.TermYear = #year# AND D.Term = #term# AND L.StudentID = #RecNo# AND C.CategoryType = 'Reward' AND C.Category = 'SKALP Certificates' AND T.TypeName = 'Best-Behaved Award' AND L.Status = 'Awarded'
	ORDER BY L.LogDate
</cfquery>
...
<table cellpadding="0" cellspacing="0" align="center" style="width:100%">
    ...
    <tr><td align="center" style="font:normal 36pt 'Georgia';color:##C00000;padding-top:3.7cm;"><b>Best Behaved Award</b></td></tr>
	...
	<tr><td align="center" style="font:normal 18pt 'Georgia';color:##818285;padding:20px 35px 0px 35px;height:160px;"><b>#Reason#</b></td></tr>
