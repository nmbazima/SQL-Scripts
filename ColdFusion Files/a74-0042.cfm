...
<cfquery name="getLBM" datasource="#dsn#">
	...
	WHERE D.TermYear = #year# AND D.Term = #term# AND L.StudentID = #RecNo# AND C.CategoryType = 'Reward' AND C.Category = 'SKALP Certificates' AND T.TypeName = 'Most Improved Academic Award' AND L.Status = 'Awarded'
	ORDER BY L.LogDate
</cfquery>
...
<table cellpadding="0" cellspacing="0" align="center" style="width:100%">
	...
	<tr><td align="center" style="font:normal 36pt 'Georgia';color:##C00000;padding-top:3.7cm;"><b>Most Improved Academic Award</b></td></tr>
