...
<cfquery name="getList" datasource="#dsn#">
	SELECT A.AcadID, A.StudID, A.LastName, A.FirstName, A.MiddleName, A.TermYear, A.Term, A.AcYear, A.BirthDate, A.Age, A.PassNo, A.Photo, A.Gender,
...
<cfquery name="getLBM" datasource="#dsn#">
	...
	WHERE D.TermYear = #year# AND D.Term = #term# AND L.StudentID = #RecNo# AND C.CategoryType = 'Reward' AND C.Category = 'SKALP Certificates' AND T.TypeName IN ('Most Improved Sportswoman of the Year Award','Most Improved Sportsman of the Year Award') AND L.Status = 'Awarded'
	ORDER BY L.LogDate
</cfquery>
...
<table cellpadding="0" cellspacing="0" align="center" style="width:100%">
	...
	<tr><td align="center" style="font:normal 36pt 'Georgia';color:##C00000;padding:3cm 0.5cm 0cm 0.5cm;"><b>#TypeName#</b></td></tr>
    <tr><td align="center" style="font:normal 12pt 'Arial';color:##C09100;padding-top:0.5cm;"><b>IS PRESENTED TO</b></td></tr>
    <tr><td align="center" style="font:normal 32pt 'Georgia';color:##818285;padding-top:0.5cm;"><b>#UCASE(getList.FirstName[i])# #UCASE(getList.MiddleName[i])# #UCASE(getList.LastName[i])#</b></td></tr>
	<tr><td align="center" style="font:normal 12pt 'Arial';color:##C09100;padding-top:0.5cm;"><b>FOR</b></td></tr>
