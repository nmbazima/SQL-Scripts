...
<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
	...
	<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
		<tr style="vertical-align:top;">
			...
			<td align="right" style="width:45%;"><img src="#fileService.getFile(fileDir = "/keydoc/images", filename = "Frontier_Nkisu_Logo.png", includeHTTP = "https:")#" style="height:2.1cm;"/></td>
		</tr>
	</table>
	</td>
	</tr>
	...
	<td>
	<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
		<tr><td class="ball txtRep11Bold" colspan="2" style="background-color:##818285;padding:3px 5px;">Descriptor</td></tr>
		<cfloop query="getOpt">
			<tr>
	...
	<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
		...
		<cfloop query="getSubj">
			<tr>
				<td class="bleft btop bbottom txtRep11Bold" colspan="2" style="color:##FFFFFF;background-color:##e2871b;padding:3px 5px;">#SubjName#</td>
				<td class="btop bottom bright txtRep11Bold" style="color:##FFFFFF;background-color:##e2871b;padding:3px 5px;">#T1Title# #LEFT(T1FName, 1)# #T1LName#</td>
			</tr>
...
<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
	...
	<table cellpadding="0" cellspacing="0" align="center" style="width:100%;">
		...
		<tr>
			<td class="bleft btop bbottom txtRep11Bold" colspan="2" style="color:##FFFFFF;background-color:##e2871b;padding:3px 5px;">#getComms.HeadingRep#</td>
			<td class="btop bottom bright txtRep11Bold" style="color:##FFFFFF;background-color:##e2871b;padding:3px 5px;">#getList.Title# #LEFT(getList.TFName[i], 1)# #getList.TLName[i]#</td>
		</tr>
	...
	<tr><td align="left" style="height:60px;"><cfif getCF.SignFile NEQ "" AND fileService.checkFileExist(fileDir  = "/keydoc/signatures/#getCF.StaffID#", filename = "#getCF.SignFile#")>
		<img src="#fileService.getFile(fileDir = "/keydoc/signatures/#getCF.StaffID#", filename = "#getCF.SignFile#", includeHTTP = "https:")#" style="height:60px;" /></cfif></td></tr>
