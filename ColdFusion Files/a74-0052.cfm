...
<td width="24%" style="padding:2px 0px;" rowspan="2" class="ball">Subject</td>
<td width="24%" class="btop bright bbottom" rowspan="2" >Teacher</td>
<td width="13%" class="btop bright bbottom" rowspan="2" >Cycle<br/>1</td>
<td colspan="3" class="btop bright bbottom">Current Cycle 2</td>
</tr>
<tr align="center" class="txtRep11Bold" style="background-color:##b4c5e7;" valign="top">
<td width="13%" class="bright bbottom">%</td>
<td width="13%" class="bright bbottom">Effort</td>
<td width="13%" class="bright bbottom">Average</td>
</tr>
