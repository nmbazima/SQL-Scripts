...
<td width="40%" style="color:##2e3192;padding-top:1cm;">End of Cycle 2 Report<br/>#DateFormat(getCF.Date1, "mmmm yyyy")#</td>
...
<td width="25%" style="padding:2px 0px;" class="ball" rowspan="2">Subject</td>
<td width="25%" class="btop bright bbottom" rowspan="2">Teacher</td>
<td width="10%" class="btop bright bbottom" rowspan="2">Cycle<br />1</td>
<td colspan="4" class="btop bright bbottom">Current Cycle 2</td>
</tr>

<tr align="center" class="txtRep11Bold" style="background-color:##b4c5e7;" valign="top">
<td width="10%" class="bright bbottom">%</td>
<td width="10%" class="bright bbottom">Symbol</td>
<td width="10%" class="bright bbottom">Effort</td>
<td width="10%" class="bright bbottom">Average</td>
</tr>
...
<td class="bright bbottom"><cfif threadResult.getDet.Mark[1] NEQ ""><b>#NumberFormat(threadResult.getDet.Mark[1])#</b></cfif></td>
<td class="bright bbottom"><cfif threadResult.getDet.Mark[2] NEQ ""><b>#NumberFormat(threadResult.getDet.Mark[2])#</b></cfif></td>
<td class="bright bbottom"><cfif threadResult.getDet.Mark[2] NEQ ""><b>#threadResult.getDet.Grade[2]#</b></cfif></td>
<td class="bright bbottom"><cfif threadResult.getSubjSum.Sumval NEQ "">#threadResult.getSubjSum.Sumval#</cfif></td>
<td class="bright bbottom"><cfif threadResult.getAvg.ClassAvgMark NEQ "">#NumberFormat(threadResult.getAvg.ClassAvgMark)#<cfelseif threadResult.getDet.AvgMark[2] NEQ "">#NumberFormat(threadResult.getDet.AvgMark[2])#</cfif></td>
</tr>
</cfif>
