<html>
    ...
    <td width="40%" style="color:##2e3192;padding-top:1cm;">End of Cycle #term# Report<br/>#DateFormat(getCF.Date1, "mmmm yyyy")#</td>
    ...
    <td width="23%" style="padding:2px 0px;" rowspan="2" class="ball" valign="center">Subject</td>
    <td width="22%" class="btop bright bbottom" rowspan="2" align="center">Teacher</td>
    <td width="11%" class="btop bright bbottom" rowspan="2" valign="center">Cycle<br/>1</td>
    <td width="11%" class="btop bright bbottom" rowspan="2" valign="center">Cycle<br/>2</td>
    <td colspan="3" class="btop bright bbottom">Current Cycle 3</td>
    </tr>
    <tr align="center" class="txtRep11Bold" style="background-color:##b4c5e7;" valign="center">
    <td width="11%" class="bright bbottom" valign="center">%</td>
    <td width="11%" class="bright bbottom" valign="center">Effort</td>
    <td width="11%" class="bright bbottom" align="center">Class <br/>Average</td>
    </tr>
    ...
    <cfif threadResult.getSubjCom.Comment NEQ "">
    <cfif threadResult.SCode NEQ getSubj.SCode[threadResult.CurrentRow-1]>
