<html>
    ...
    <td width="40%" style="color:##2e3192;padding-top:1cm;">End of Cycle 3 Report<br/>#DateFormat(getCF.Date1, "mmmm yyyy")#</td>
    ...
    <td width="23%" style="padding:2px 0px;" class="ball" rowspan="2">Subject</td>
    <td width="22%" class="btop bright bbottom" rowspan="2">Teacher</td>
    <td width="10%" class="btop bright bbottom" rowspan="2">Cycle<br />1</td>
    <td width="10%" class="btop bright bbottom" rowspan="2">Cycle<br />2</td>
    <cfif listfind('Yr10_TCS',getlist.AcYear[i])>
    <td colspan="4" class="btop bright bbottom"> Current Cycle 3</td>
    <cfelse>
    <td colspan="3" class="btop bright bbottom"> Mock Examination</td>
    </cfif>
    <cfif NOT listFind('Yr10_TCS', getList.AcYear[i])>
    <td rowspan="2" width="11%" class="btop bright bbottom">  Weighted Year <b/> Mark</td>
    </cfif>
    </tr>
    
    <tr align="center" class="txtRep11Bold" style="background-color:##b4c5e7;" valign="center">
    <td width="8%" class="bright bbottom">%</td>
    <td width="9%" class="bright bbottom">Symbol</td>
    <td width="9%" class="bright bbottom">Effort</td>
    <cfif listFind('Yr10_TCS', getList.AcYear[i])>
    <td width="11%" class=" bright bbottom">Class <br/>Average</td>
    </cfif>
    </tr>
    ...
    <td class="bright bbottom"><cfif threadResult.getDet.Mark[1] NEQ "">#NumberFormat(threadResult.getDet.Mark[1])#</cfif></td>
    <td class="bright bbottom"><cfif threadResult.getDet.Mark[2] NEQ "">#NumberFormat(threadResult.getDet.Mark[2])#</cfif></td>
    <td class="bright bbottom"><cfif threadResult.getDet.Mark[3] NEQ ""><b>#NumberFormat(threadResult.getDet.Mark[3])#</b></cfif></td>
    <td class="bright bbottom"><cfif threadResult.getDet.Mark[3] NEQ "">#threadResult.getDet.Grade[3]#</cfif></td>
    <td class="bright bbottom"><cfif threadResult.getSubjSum.Sumval NEQ "">#threadResult.getSubjSum.Sumval#</cfif></td>
    <cfif listFind('Yr10_TCS', getList.AcYear[i])>
    <td class="bright bbottom"><cfif threadResult.getAvg.ClassAvgMark NEQ ""><b>#NumberFormat(threadResult.getAvg.ClassAvgMark)#</b><cfelseif threadResult.getDet.AvgMark[3] NEQ ""><b>#NumberFormat(threadResult.getDet.AvgMark[3])#</b></cfif></td>
    <cfelse>
    <td class="bright bbottom"><cfif threadResult.getDet.YMMark[3] NEQ ""><b>#NumberFormat(threadResult.getDet.YMMark[3])#</b></cfif></td>
    </cfif>
    </tr>
    </cfif>
